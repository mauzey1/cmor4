...
# Type hint settings
autodoc_typehints = 'both'  # Show type hints in signature and parameter descriptions
...
python_use_unqualified_type_names = True  # Use short names (e.g., Dataset instead of xarray.Dataset)
